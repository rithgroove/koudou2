...
class GPSCoordinate():  
    ...
    def translate(self,lat =0,lon = 0):
        ...
        Parameter:
            - lat : [Double] latitude translation. (default =0)
            - lon : [Double] longitude translation. (default =0)
        """
        self.lat += lat
        self.lon += lon
    ...
    def new_coordinate_with_scale(self,scale = 1.0):
        """
        ...
        return :
            - [Coordinate] a clone of this coordinate with the scaling applied. (default = 1.0)
